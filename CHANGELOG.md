...
### Maintenance
* Fixed dependency of `CalculateJudgmentsIT.java` on UBI plugin and created a fallback withn plugin does not exist. ([#311](https://github.com/opensearch-project/search-relevance/pull/311))
