...
#
# USAGE:
#   ./demo_import_pairwise_experiment.sh [OPENSEARCH_URL]
#
# PARAMETERS:
...
#   ./demo_import_pairwise_experiment.sh
#
#   # Use a remote OpenSearch instance
#   ./demo_import_pairwise_experiment.sh "http://chorus-opensearch-edition.dev.o19s.com:9200"
#
# Helper script
