...
/**
 * Rest action that searches query sets using OpenSearch query DSL.
 */
@AllArgsConstructor
public class RestSearchQuerySetAction extends BaseRestHandler {
    private static final Logger LOGGER = LogManager.getLogger(RestSearchQuerySetAction.class);
    private static final String SEARCH_QUERYSET_ACTION = "search_queryset_action";
    private final SearchRelevanceSettingsAccessor settingsAccessor;

    @Override
    public String getName() {
        return SEARCH_QUERYSET_ACTION;
    }

    @Override
    public List<Route> routes() {
        String searchPath = QUERYSETS_URL + "/_search";
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        return channel -> client.execute(SearchQuerySetAction.INSTANCE, searchRequest, new ActionListener<>() {
            @Override
