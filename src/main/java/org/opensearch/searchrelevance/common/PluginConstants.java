...
public class PluginConstants {
    ...
    /**
     * Dashboard evaluation related constants
     */
    public static final String DASHBOARD_KEY_PREFIX = "DashboardKey";
    public static final String DASHBOARD_SEARCH_CONFIG_KEY = "DashboardKeySearchConfig";
    public static final String DASHBOARD_QUERY_SET_KEY = "DashboardKeyQuerySet";
}
